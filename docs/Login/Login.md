...
If the user logs in for the first time, it is mandatory to change the default password. Please refer to the interface prompts for password rules.

![](./Img/3f3412765dcd513154bdda0398158f0f.png)
